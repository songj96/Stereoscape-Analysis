...
for file_path in audio_files:
    ...
    plt.plot(avg_time, avg_panning, c='k', label='Average Panning')
    ...
    plot_filename = os.path.join(graph_dir, os.path.splitext(os.path.basename(file_path))[0] + '_lineplot.png')
